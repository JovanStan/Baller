...
/*ADD*/		void DrawCylinder(const btScalar &radius, const btScalar &halfHeight);
	...
	GameObject* makeKey2(btCollisionShape* pShape, const float& mass, const btVector3& color, const btVector3& initialPosition);
	...
	void destroyKeyObject2(btRigidBody* pBody);
